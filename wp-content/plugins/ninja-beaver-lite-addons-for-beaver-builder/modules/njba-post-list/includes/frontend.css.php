...
.fl-node-<?php echo $id; ?> .njba-blog-posts-list .njba-post-wrapper{
       <?php if( $settings->post_spacing['top'] != '' ) { ?>padding-top: <?php echo $settings->post_spacing['top']; ?>px;<?php } ?> 
       <?php if( $settings->post_spacing['bottom'] != '' ) { ?>padding-bottom: <?php echo $settings->post_spacing['bottom']; ?>px;<?php } ?> 
       <?php if( $settings->post_spacing['left'] != '' ) { ?>padding-left: <?php echo $settings->post_spacing['left']; ?>px;<?php } ?> 
       <?php if( $settings->post_spacing['right'] != '' ) { ?>padding-right: <?php echo $settings->post_spacing['right']; ?>px;<?php } ?> 
...
.fl-node-<?php echo $id; ?> .njba-blog-separator span {
    <?php if($settings->separator_border_style != 'none'){?> border-bottom: <?php echo $settings->separator_border_width ;?>px <?php echo $settings->separator_border_style ;?> #<?php echo $settings->separator_border_color; ?>;<?php } ?>
     <?php if($settings->separator_border_style == 'none'){?> border-bottom: none;<?php } ?>
    <?php if($settings->separator_border_style != 'none'){ if($settings->separator_size != 'none'){?> width:<?php echo $settings->separator_size ; ?>%;<?php }?><?php } ?>
}
/***** For Pagination   css *****/
...
.fl-node-<?php echo $id; ?> .njba-pagination li span.page-numbers{
           ...
           <?php if($settings->pagination_border != 'none'){?> border-radius: <?php echo $settings->pagination_border_radius ;?>px ;<?php } ?>
            padding: <?php echo $settings->pagination_padding['top'];?>px <?php echo $settings->pagination_padding['right'];?>px <?php echo $settings->pagination_padding['bottom'];?>px <?php echo $settings->pagination_padding['left'];?>px;
