...
<div id="fl-builder-settings-section-filter" class="fl-builder-settings-section">
	...
	<?php foreach(FLBuilderLoop::post_types() as $slug => $type) : ?>
		<table class="fl-form-table fl-loop-builder-filter fl-loop-builder-<?php echo $slug; ?>-filter njba-filter-deactive" <?php if($slug == $settings->post_type) echo 'style="display:table;"'; ?>>
		<?php
		// Posts
...
<script type="text/javascript">
	;(function($) {
		$('.fl-builder-njba-post-list-settings select[name="post_type"]').on('change', function() {
			...
			var post_taxonomies 	= $('.fl-builder-njba-post-list-settings select[name="post_taxonomies"]');
