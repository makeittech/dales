...
for($i=0; $i < count($settings->photos); $i++)
{
...
.fl-node-<?php echo $id; ?> .njba-slider-main .bx-thumbnail-pager i{
           ...
           <?php if( $settings->toggle_color  != null) { ?>color:#<?php echo $settings->toggle_color; ?>;<?php } ?>
...
<?php } ?>
        .njba-slider-main .njba-cta-box-main-stacked .njba-cta-box-body {width: 90%;height: 100%;display: table;text-align: center;}
        .njba-slider-main .njba-cta-box-main-stacked .njba-cta-box-content{vertical-align: middle;width: 100%;height: 100%;display: table-cell;}
        .njba-slider-main .njba-cta-box-main-stacked{left: 0 !important;right: 0;width: 80%;top: 0 !important; }
        .njba-slider-main .njba-cta-box-main-stacked .njba-heading-title{margin-top: 0px;}
        .njba-slider-main .njba-cta-box-main-stacked .njba-heading-sub-title{ margin-top: 10px;}
        .njba-slider-main .njba-cta-box-main-stacked .njba-btn-main a.njba-btn{ margin-top: 0px;padding-top: 10px;padding-right: 20px;padding-bottom: 10px;padding-left: 20px;margin-bottom: 15px;}
}
@media ( max-width: 767px ) {
